...
def main():
    def setup_player():
        ...
        player_name = input("Greetings, adventurer. What is your name?")
    ...
    def search_room(player, treasures):
        ...
        if outcome == "treasure":
            ...
            print(f"Looks like luck was on your side. You found a {found_treasure}")
        
        elif outcome == "trap":
            player["health"] = player["health"] -2
            print(f"The room was booby trapped! You lost 2 health. Current health: {player["health"]}")
    ...
    def end_game(player, treasures):
        ...
        print(f"Game over. Player stats:")
        print(f"Health: {player['health']}")
        print(f"Inventory: {', '.join(player['inventory'])}")
